...
for i = 2:length(transformed_signal)-1
    % fprintf(""""+transformed_signal(:,i)'+""" AFTER 10ns,"+ "\n");
    fprintf(""""+transformed_signal(:,i)'+""" AFTER " + (i-1)*10 + "ns,"+ "\n");
end
fprintf(""""+transformed_signal(:,i)'+""" AFTER " + (length(transformed_signal)-1)*10 + "ns;"+ "\n");

%% Analyze
result_tb = [-304683096 -859613292 -1077699264 -872841024 -332699388 332699388 858369336 1051339896 858369336 332699388];
